...
function ws_scripts() {
    ...
    wp_enqueue_script( 'ngacustom', get_bloginfo('template_url') . '/js/custom.js', 'jquery', '1.2', true );
    ...
    wp_enqueue_style( 'mc_main', get_bloginfo('template_url') . '/main.css', array('bootstrap'), false );
...
add_action( 'widgets_init', 'ws_widget_init' );
